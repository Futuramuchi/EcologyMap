...
//        map.addAnnotation(ann)
    ...
    func makeCoordinator() -> Coordinator {
        return MapView.Coordinator(selectedStation: stations[0], locationViewModel: locationViewModel)
    }
    
    class Coordinator: NSObject, MKMapViewDelegate{
        var selectedStation: StationModel
        var locationViewModel: LocationManagerViewModel
        init(selectedStation: StationModel, locationViewModel: LocationManagerViewModel){
